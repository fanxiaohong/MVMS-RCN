...
if __name__ == "__main__":
    ...
    # parser.add_argument('--data_path', type=str, default='./data/CT/')
    parser.add_argument('--saved_path', type=str, default='./data/CT/parallel/')
    parser.add_argument('--save_path', type=str, default='./save/ds12-1000/')
    parser.add_argument('--test_patient', type=str, default='test')
    parser.add_argument('--result_fig', type=bool, default=True)

    parser.add_argument('--ds_factor', type=int, default=12, help='from {24,12, 8, 6, 4}')
