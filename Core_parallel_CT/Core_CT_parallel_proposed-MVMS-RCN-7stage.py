...
from model_RU6_parallel_MVMS_RCN_share_denoiser import ResUnet
from solver_CT_together_parallel_iterator import Solver_CT
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-new-together')
parser.add_argument('--net_name', type=str, default='CT-parallel-RU6-MVMS-RCN-share-7stage', help='name of net')
parser.add_argument('--model_dir', type=str, default='model_parallel_CT', help='model_MRI,model_CT,trained or pre-trained model directory')
...
parser.add_argument('--CT_test_name', type=str, default='CT_test_parallel', help='save name of CT test set')
