...
def CT_dataloader(num_work,batch_size,run_mode):
    # train data
    if run_mode == 'train':
        train_data_Name = './data/train/full_sampled1.mat'
        ...
        for i in range(7):  # eight files train labels
            train_full_sampled_data_Name = './data/train/full_sampled' + str(i + 2) + '.mat'
        ...
        # val data
        val_data_Name = './data/val/full_sampled.mat'
    ...
    # test data
    test_data_Name = './data/test/full_sampled.mat'
