...
trunc_mode ='HU' # 'HU、liver, lung
save_mode = 0  # 1 save , 0 don't save

##########################################################################################
exact_image_str = './result_HU/label_mat_dataset2/'  # ground truth image 所在位置
predict_image_str = './result_HU/ds'+str(ds_factor)+'_dataset2/100-'+str(TV_lambda)+'_mat/' # predict image image 所在位置，
