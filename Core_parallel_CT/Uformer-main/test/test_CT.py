...
parser.add_argument('--result_dir', default='./results/denoising/CT/Uformer_B-parallel-ds12/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='../train/logs/denoising/CT/Uformer_B_/models-parallel-ds12/model_best.pth',
