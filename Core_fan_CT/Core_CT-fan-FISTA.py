...
from model_FISTANet_fan import FISTANet
from solver_CT_together_fan import Solver_CT
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-new')
parser.add_argument('--net_name', type=str, default='CT-FISTA-fan-ds32', help='name of net')
...
parser.add_argument('--loss_mode', type=str, default='Fista-net', help='vggloss,midloss,L1,L2,Fista-net')
parser.add_argument('--penalty_mode', type=str, default='Fista-net', help='Fista-net,Weight,None')
...
model = FISTANet(args.layer_num, args.num_features)
###################################################################################
# model
