...
from model_ISTANetplus_fan import ISTANetplus
from solver_CT_together_fan import Solver_CT
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-new')
parser.add_argument('--net_name', type=str, default='CT-fan-ISTANetplus-ds32', help='name of net')
...
model = ISTANetplus(args.layer_num, args.num_features)
###################################################################################
# model
