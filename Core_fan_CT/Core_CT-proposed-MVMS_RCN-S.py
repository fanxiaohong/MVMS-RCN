...
from model_RU6_fan_MVMS_RCN_share import MVMS_RCN
from solver_CT_together_fan import Solver_CT
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-new-together')
parser.add_argument('--net_name', type=str, default='CT-fan-proposed-RU6-MVMS-RCN-S-share-fan', help='name of net')
