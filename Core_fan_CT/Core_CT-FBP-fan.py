...
from solver_CT_FBP_fan import Solver_CT_FBP
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-FBP')
parser.add_argument('--net_name', type=str, default='CT-FBP-fan-HU', help='name of net')
...
parser.add_argument('--CT_test_name', type=str, default='CT_test-HU-fan', help='name of CT test set')
