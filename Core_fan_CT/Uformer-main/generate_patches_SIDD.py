...
parser.add_argument('--src_dir', default='./groundtruth_test/', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='./datasets/denoising/train',type=str, help='Directory for image patches')
...
#get sorted folders
# files = natsorted(glob(os.path.join(src, '*.*')))
