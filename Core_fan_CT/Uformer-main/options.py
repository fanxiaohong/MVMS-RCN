...
class Options():
    ...
    def init(self, parser):        
        ...
        # parser.add_argument('--pretrain_weights',type=str, default='./log/Uformer_B/models-fan-ds32/model_best.pth', help='path of pretrained_weights')
        ...
        parser.add_argument('--train_dir', type=str, default ='../../result/',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='../../result/',  help='dir of train data')
