...
from model_ISTANet_fan import ISTANet
from solver_CT_together_fan import Solver_CT
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-fan-new')
parser.add_argument('--net_name', type=str, default='CT-fan-ISTA-ds32', help='name of net')
...
parser.add_argument('--loss_mode', type=str, default='Ista-net', help='vggloss,midloss,L1,L2,Fista-net,Ista-net')
...
model = ISTANet(args.layer_num, args.num_features)
###################################################################################
# model
