...
from model_FBPConNet_fan import FBPConNet
from solver_CT_together_fan import Solver_CT
###########################################################################################
# parameter
parser = ArgumentParser(description='CT-new')
parser.add_argument('--net_name', type=str, default='CT-FBPConNet-fan-ds32', help='name of net')
...
parser.add_argument('--layer_num', type=int, default=1, help='D,11')
parser.add_argument('--num_features', type=int, default=64, help='G,32')
...
parser.add_argument('--CT_test_name', type=str, default='CT_test-HU', help='name of CT test set')
...
model = FBPConNet(args.num_features)
###################################################################################
# model
