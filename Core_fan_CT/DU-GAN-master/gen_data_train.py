...
for phase in ['train']:
    ...
    train_data_Name = './' + 'CT_' + phase + '1_CT-FBP-fan/FBP_1.npy'
    train_full_sampled_data = np.load(train_data_Name)
    for i in range(7):  # eight files train labels
        train_data_Name = './' + 'CT_' + phase + str(i + 2) + '_CT-FBP-fan/FBP_1.npy'
    ...
    # load FBP images
    train_data_Name_FBP = './' + 'CT_' + phase + '1_CT-FBP-fan/FBP_' + str(ds_factor) + '.npy'
    train_full_sampled_data_FBP = np.load(train_data_Name_FBP)
    for i in range(7):  # eight files train labels
        train_data_Name_FBP = './' + 'CT_' + phase + str(i + 2) + '_CT-FBP-fan/FBP_' + str(ds_factor) + '.npy'
