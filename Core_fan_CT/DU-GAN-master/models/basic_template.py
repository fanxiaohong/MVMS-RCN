...
class TrainTask(object):
    ...
    def build_default_options():
        ...
        parser.add_argument('--train_dataset_name', type=str, default='train_ds32_fan')
        parser.add_argument('--test_dataset_name', type=str, default='test_ds32_fan')
        parser.add_argument('--run_name', type=str, default='default_fan_ds32', help='each run name')  # 保存的文件名
